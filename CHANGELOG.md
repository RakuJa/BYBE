...
- Add description parsing, real-time variant damage. (#149)
- Add new item types (ammunition, backpack, treasure) (#150)

### Fixed

- Id parsing error on spells (#148)

## [5.0.0] - 2026-07-07

### Added

- Add weapon attack effect (e.g. grab) (#141)
- Add display names for trait, for future usage (#142)
- Add conditions both as standalone values and in creature struct (#144)

### Feature

- Separate BYBE core (this repo) from Backend (#134)
- Improve range struct, exposing more info (#138)
- Improve traits by adding description and improved names (#140)
- Restructure hazard (#145)

### Fixed

- Db queries not working correctly (#137)
- Sql injection, optimize query rtt (#143)
- Creature listing never returned traits (#146)

### Removed

- Remove SQLite in favour of Postgres (#135)
- Remove cache-based logic (#136)
...
[5.1.0]: https://github.com/RakuJa/BYBE/compare/v5.0.0..v5.1.0
[5.0.0]: https://github.com/RakuJa/BYBE/compare/v4.1.0..v5.0.0
[4.1.0]: https://github.com/RakuJa/BYBE/compare/v4.0.2..v4.1.0
[4.0.2]: https://github.com/RakuJa/BYBE/compare/v4.0.1..v4.0.2
