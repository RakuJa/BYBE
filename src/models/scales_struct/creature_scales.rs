...
pub struct CreatureScales {
    pub ability_scales: HashMap<i64, AbilityScales>,
    pub ac_scales: HashMap<i64, AcScales>,
    pub area_dmg_scales: HashMap<i64, AreaDmgScales>,
    pub hp_scales: HashMap<i64, HpScales>,
    pub item_scales: HashMap<String, ItemScales>,
    pub perception_scales: HashMap<i64, PerceptionScales>,
    pub res_weak_scales: HashMap<i64, ResWeakScales>,
    pub saving_throw_scales: HashMap<i64, SavingThrowScales>,
    pub skill_scales: HashMap<i64, SkillScales>,
    pub spell_dc_and_atk_scales: HashMap<i64, SpellDcAndAtkScales>,
    pub strike_bonus_scales: HashMap<i64, StrikeBonusScales>,
    pub strike_dmg_scales: HashMap<i64, StrikeDmgScales>,
}
